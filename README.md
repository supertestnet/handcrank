...
8. During the delay, any miner who rejects the claim can extend the delay to 6 months
...
## 7 & 8. Any bitcoin miner can check the new person’s claim and start sending them Alice’s deposit, and during the delay, any miner who rejects the claim can extend the delay to 6 months
