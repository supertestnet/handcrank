...
Use a multisig with 51% of miners to emulate a covenant and use that covenant to make a hashrate escrow (and thus a drivechain). This should be fine because drivechain assumes 51% of miners are honest anyway.
